...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        ### TODO:
        ###     This method should convert characters in the input_tensor sentences into their
    ...
    def to_input_tensor_char(self, sents: List[List[str]],
        ...
        sents_var_reshaped = torch.transpose(sents_var, 0, 1)
        return sents_var_reshaped
